...
window.__ModuleLoader__.load({
  ...
  // rename missed this once already, so the browser bundle "loaded without
  // registering"; the acryl-dsh-editor-plugin -> acryl-dsh-editor-plugin-web
  // rename updates it here too).
  id: "acryl-dsh-editor-plugin-web",
  factory: (require) => {
